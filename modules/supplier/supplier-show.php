...
<ul class="breadcrumbs">
  ...
  <li class="disabled">Detail Supplier Laundry</li>
</ul>
</nav>
...
<a href="?modules supplier-delete&id=<?php echo $r['id']; ?>"onClick='return confirm("Apakah yakin menghapus?")' class="alert button">Delete</a>
